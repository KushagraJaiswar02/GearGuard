        ...
        <div className="flex min-h-screen items-center justify-center bg-background p-4 text-foreground selection:bg-primary/20">
            <div className="w-full max-w-sm space-y-8">
                    ...
                    <form onSubmit={handleSubmit} className="grid gap-4">
                        ...
                        <div className="grid gap-2">
                            <div className="flex items-center justify-between">
                                ...
                                <a href="#" className="text-xs text-muted-foreground hover:text-primary hover:underline">Forgot?</a>
                            </div>
                            <input
                                id="password"
                                type="password"
                ...
                <p className="text-center text-sm text-muted-foreground">
                    ...
                    <Link to="/signup" className="font-medium text-foreground underline-offset-4 hover:text-primary hover:underline">Sign up</Link>
                </p>
            </div>
        </div>
    );
